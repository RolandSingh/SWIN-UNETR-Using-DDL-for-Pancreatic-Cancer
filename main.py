...
parser.add_argument("--data_path", type=str, default=None, help="Path to dataset root containing imagesTr and labelsTr")
...
if args.data_path is None:
    # Try common dataset locations automatically
    possible = [
        "./dataset",
        "./BraTS",
        "./Task01_BrainTumour",
    ...
    for p in possible:
        if os.path.exists(p):
            ...
            break
    if found is None:
        raise RuntimeError("Dataset path not provided and no default dataset folder found. Use --data_path")
